    ...
    <div class="max-w-[90rem] mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
            ...
            <ul class="flex flex-col gap-2">
                <li><a href="<?= BASE_DIR ?>/campanhas" class="text-secondary/60 hover:text-primary text-sm transition-colors no-underline">Campanhas</a></li>
                <li><a href="<?= BASE_DIR ?>/cronicas" class="text-secondary/60 hover:text-primary text-sm transition-colors no-underline">Crônicas</a></li>
                
                <?php if (!$isAdmin): ?>
                    <li><a href="<?= BASE_DIR ?>/loja" class="text-secondary/60 hover:text-primary text-sm transition-colors no-underline">Loja Virtual</a></li>
                <?php endif; ?>
            </ul>
        </div>
        <div>
            ...
            <ul class="flex flex-col gap-2">
                <li><a href="<?= BASE_DIR ?>/planos" class="text-secondary/60 hover:text-primary text-sm transition-colors no-underline">Assinaturas</a></li>
                <li><a href="<?= BASE_DIR ?>/suporte" class="text-secondary/60 hover:text-primary text-sm transition-colors no-underline">Suporte aos Escribas</a></li>
            </ul>
        </div>
    </div>
